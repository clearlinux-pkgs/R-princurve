...
%setup -q -n princurve
pushd ..
cp -a princurve buildavx2
popd
pushd ..
cp -a princurve buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737153299
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/princurve/libs/princurve.so
/V4/usr/lib64/R/library/princurve/libs/princurve.so
