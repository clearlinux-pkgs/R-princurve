...
Version  : 2.0.3
Release  : 13
URL      : https://cran.r-project.org/src/contrib/princurve_2.0.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/princurve_2.0.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530844200
